    ...
    return (
        <div className="bg-[#282C33] min-h-screen flex flex-col">
            ...
            <div id="home" className="flex-grow flex flex-col md:flex-row items-center justify-between px-4 md:px-8 lg:px-16 xl:px-24 mt-14"> 
                {/* Left Side */}
                <div className="text-white space-y-4 max-w-md mb-8 md:mb-0 mt-12 md:mt-0 text-center md:text-left mt-6">
                    <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-4xl font-bold">
                        Skillscope is a <span className='fontStyle'>web designer</span> and <span className='fontStyle'>front-end <br />developer</span> 
                    </h1>
